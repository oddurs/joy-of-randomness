...
def generate_figure_1_1(num_points=200):
    """
    Figure 1.1.1: Random Points in a Square
    ...
    with figure(1, 1, 1, figsize=(8, 8), output_dir=OUTPUT_DIR) as fig:
...
def generate_figure_1_3():
    """
    Figure 1.1.3: The Birthday Paradox
    ...
    with figure(1, 1, 3, output_dir=OUTPUT_DIR) as fig:
        ax = fig.add_subplot(111)
...
def generate_figure_1_4(num_points=200, num_cells=10):
    """
    Figure 1.1.4: Clustering in a Grid
    ...
    with figure(1, 1, 4, figsize=(10, 8), output_dir=OUTPUT_DIR) as fig:
        ax = fig.add_subplot(111)
...
def generate_figure_1_5(num_simulations=1000):
    """
    Figure 1.1.5: Hot Hand vs Random
    ...
    with figure(1, 1, 5, figsize=(12, 5), output_dir=OUTPUT_DIR) as fig:
...
def generate_all_figures():
    ...
    print("Generating Figure 1.1.1: Random Points in a Square")
    generate_figure_1_1()
    
    print("Generating Figure 1.1.2: Distribution of Longest Streaks")
    generate_figure_1_2()
    
    print("Generating Figure 1.1.3: The Birthday Paradox")
    generate_figure_1_3()
    
    print("Generating Figure 1.1.4: Clustering in a Grid")
    generate_figure_1_4()
    
    print("Generating Figure 1.1.5: Hot Hand vs Random")
    generate_figure_1_5()
