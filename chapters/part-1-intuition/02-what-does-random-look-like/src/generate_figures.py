...
def generate_figure_2_1(num_sequences=10000, flips_per_sequence=100):
    """
    Figure 1.2.1: Distribution of Longest Streaks
    ...
    with figure(1, 2, 1, output_dir=OUTPUT_DIR) as fig:
...
def generate_figure_2_2(num_sequences=10000, flips_per_sequence=100):
    """
    Figure 1.2.2: Distribution of Runs (Transitions)
    ...
    with figure(1, 2, 2, output_dir=OUTPUT_DIR) as fig:
        ax = fig.add_subplot(111)
...
def generate_figure_2_3(flips_long=10000):
    """
    Figure 1.2.3: Running Proportion Convergence
    ...
    with figure(1, 2, 3, figsize=(10, 6), output_dir=OUTPUT_DIR) as fig:
        ax = fig.add_subplot(111)
...
def generate_figure_2_4(num_sequences=100, flips_per_sequence=100):
    """
    Figure 1.2.4: Comparison of Runs: Fair vs Over-Alternating
    ...
    with figure(1, 2, 4, figsize=(10, 6), output_dir=OUTPUT_DIR) as fig:
        ax = fig.add_subplot(111)
...
def generate_figure_2_5(num_simulations=100):
    """
    Figure 1.2.5: Streak Distribution Across Sequences
    ...
    with figure(1, 2, 5, figsize=(12, 5), output_dir=OUTPUT_DIR) as fig:
...
def generate_all_figures():
    ...
    print("Figure 1.2.1: Distribution of Longest Streaks...")
    generate_figure_2_1()
    print()
    
    print("Figure 1.2.2: Distribution of Runs (Transitions)...")
    generate_figure_2_2()
    print()
    
    print("Figure 1.2.3: Running Proportion Convergence...")
    generate_figure_2_3()
    print()
    
    print("Figure 1.2.4: Fair vs Over-Alternating Sequences...")
    generate_figure_2_4()
    print()
    
    print("Figure 1.2.5: Streak and Run Variability...")
    generate_figure_2_5()
    print()
